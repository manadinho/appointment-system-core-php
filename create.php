...
<style>
    ...
    * {
    ...
    .ps-form__submit > div:nth-child(1) {
        text-align: left;
    }

    .ps-form__submit > div:nth-child(2) {
        text-align: center;
    }

    .ps-form__submit > div:nth-child(3) {
        text-align: right;
    }
                ...
                <div class="tab active">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group short">
                            ...
                            <input class="form-control" name="siblings" type="text">
                        </div>
                        <div class="form-group short">
                        ...
                        <div class="form-group short">
                            ...
                            <input class="form-control" name="family_structure" type="text">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="problems"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>History Of Problems</label>
                                <textarea class="form-control" name="history_of_problems"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Complaints</label>
                                <input class="form-control" name="complaints" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Frequency</label>
                                <input class="form-control" name="frequency" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Intensity</label>
                                <input class="form-control" name="intensity" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="prior_treatments"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="family_psychiatry_history"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Family Medical History</label>
                                <textarea class="form-control" name="family_medical_history"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Family Relationship</label>
                                <textarea class="form-control" name="family_relationship"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Client Relationship with Family</label>
                                <textarea class="form-control" name="client_family"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Family Relationship with Client</label>
                                <textarea class="form-control" name="family_client"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="marital_details"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Spouse & No. of Children</label>
                                <input class="form-control" name="spouse_children" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Client Relationship with Spouse</label>
                                <textarea class="form-control" name="client_spouse"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Spouse Relationship with Client</label>
                                <textarea class="form-control" name="spouse_client"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="client_colleagues"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Colleagues Relationship with Client</label>
                                <textarea class="form-control" name="colleagues_client"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Number of Jobs Changed</label>
                                <input class="form-control" name="jobs_changed" type="number" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Reasons for Changing Jobs</label>
                                <textarea class="form-control" name="job_reasons"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="schools_changed" type="number" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>School Name</label>
                                <input class="form-control" name="school_name" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Reasons for Changing Schools</label>
                                <textarea class="form-control" name="school_reasons"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Client Relationship with Peers</label>
                                <textarea class="form-control" name="client_peers"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Client Relationship with Teachers</label>
                                <textarea class="form-control" name="client_teachers"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="social_history"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="orientation" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Sleep Issues</label>
                                <input class="form-control" name="sleep" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="behavior"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="diagnosis" type="text" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
  ...
  <script>
    ...
    // TOAST MESSAGES //
    function toastMessage(title = 'Success', text = 'Operation completed.', status = 'success') {
      new Notify({
        status,
        title,
        text,
